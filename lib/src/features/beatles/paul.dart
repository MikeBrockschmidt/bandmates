...
void main() {
  runApp(const PaulDetailPage());
}

class PaulDetailPage extends StatelessWidget {
  const PaulDetailPage({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: appTheme,
      home: const PaulMcCartneyAlbumScreen(),
    );
  }
}

class PaulMcCartneyAlbumScreen extends StatefulWidget {
  const PaulMcCartneyAlbumScreen({super.key});

  @override
  State<PaulMcCartneyAlbumScreen> createState() =>
      _PaulMcCartneyAlbumCreenState();
}

class _PaulMcCartneyAlbumCreenState extends State<PaulMcCartneyAlbumScreen> {
          ...
          children: [
            if (_errorMessage.isNotEmpty)
              ...
              Column(
                children: [
                  Image.asset(
                    DatabaseRepository.paulStartImagePath,
                    height: 200,
                  ),
