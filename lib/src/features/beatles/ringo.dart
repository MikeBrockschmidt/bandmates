...
void main() {
  runApp(const RingoDetailPage());
}

class RingoDetailPage extends StatelessWidget {
  const RingoDetailPage({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: appTheme,
      home: const RingoStarrAlbumScreen(),
    );
  }
}

class RingoStarrAlbumScreen extends StatefulWidget {
  const RingoStarrAlbumScreen({super.key});

  @override
  State<RingoStarrAlbumScreen> createState() => _RingoStarrAlbumScreenState();
}

class _RingoStarrAlbumScreenState extends State<RingoStarrAlbumScreen> {
          ...
          children: [
            if (_errorMessage.isNotEmpty)
              ...
              Column(
                children: [
                  Image.asset(
                    DatabaseRepository.ringoStartImagePath,
                    height: 200,
                  ),
