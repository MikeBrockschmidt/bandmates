...
void main() {
  runApp(const GeorgeDetailPage());
}

class GeorgeDetailPage extends StatelessWidget {
  const GeorgeDetailPage({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: appTheme,
      home: const GeorgeHarrisonAlbumScreen(),
    );
  }
}

class GeorgeHarrisonAlbumScreen extends StatefulWidget {
  const GeorgeHarrisonAlbumScreen({super.key});

  @override
  State<GeorgeHarrisonAlbumScreen> createState() =>
      _GeorgeHarrisonAlbumScreenState();
}

class _GeorgeHarrisonAlbumScreenState extends State<GeorgeHarrisonAlbumScreen> {
          ...
          children: [
            if (_errorMessage.isNotEmpty)
              ...
              Column(
                children: [
                  Image.asset(
                    DatabaseRepository.georgeStartImagePath,
                    height: 200,
                  ),
